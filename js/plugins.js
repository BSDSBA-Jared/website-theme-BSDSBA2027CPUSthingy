...
attributes.forEach((attr) => {
  ...
  function swap_this(){
    if(window_width <= 600){
      if ($("body").hasClass("front_page")){
        ...
        $('.header_right_holder').insertAfter('.main_logo');
        $('.copyright').insertAfter('.footer_nav');
        } else{
        //non home  
        $('.main_logo').insertAfter('.logo_wrap');
        $('#nav_area').insertBefore('header');
        $('.header_right_holder').insertAfter('.header_info');
        $('.copyright').insertAfter('.footer_nav');
        }
        ...
        $('#nav_area').insertAfter('header');
        $('.header_right_holder').appendTo('.page_nav .wrapper');
  ...
  $(window).scroll(function () {
    ...
    if ($("#bottom_parallax_con").length >= 1) {
      var fixbtm = $("#bottom_parallax_con").offset().top;
      if (fixbtm <= windowScroll && window_width > 1024) {
        $("#bottom_parallax_con").css({
  ...
  function runOwl() {
    $(".btm2_boxes").addClass("owl-carousel");
    $(".btm2_boxes").addClass("owl-theme");
    $(".owl-carousel").owlCarousel({
      items: 1,
      nav: false,
      dots: true,
  ...
  function destroyOwl() {
    ...
    $(".btm2_boxes").removeClass("owl-carousel");
    $(".btm2_boxes").removeClass("owl-theme");
    isOwlInitialized = false;
  }

  function initializeOwlCarousel() {
    if (window_width <= 800 && isOwlInitialized === false) {
      return runOwl();
    } else if (window_width > 800 && isOwlInitialized === true) {
      return destroyOwl();
    }
  }
